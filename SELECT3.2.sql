...
SELECT * FROM (SELECT CAREER.EMPNO, DEPT.DEPTNAME, DEPT.DEPTADDR CAREER LEFT JOIN DEPT USING(DEPTNO));
------------------------------------------------------
--ОПЕРАТОР CAST
------------------------------------------------------
...
FROM DEPT;
------------------------------------------------------
--ОПЕРАТОР COALESCE (если значение столбца NULL, то заменяем на второй аргумент)
------------------------------------------------------
